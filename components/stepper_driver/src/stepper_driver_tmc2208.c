...
esp_err_t tmc2208_set_tpowerdown(stepper_driver_t *handle, uint8_t tpowerdown) {
    ...
    tmc2208->tpowerdown.reg.tpowerdown = tpowerdown; 

    write_register_safe(tmc2208, (tmc2208_datagram_t *)&tmc2208->tpowerdown);
...
stepper_driver_t *stepper_driver_new_tmc2208(const stepper_driver_tmc2208_conf_t *config)
{
   ...
   tmc2208->parent.read_register_mscuract = tmc2208_read_register_mscuract;
    ...
    tmc2208->parent.reversed = stepper_driver_reversed;
...
esp_err_t tmc2208_reversed(stepper_driver_t *handle, uint8_t reversed) {
  ...
  tmc2208->gconf.reg.shaft = reversed;
